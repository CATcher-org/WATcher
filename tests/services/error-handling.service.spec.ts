...
describe('ErrorHandlingService', () => {
  ...
  describe('ErrorHandlingService: handleError()', () => {
    ...
    it('should use the GeneralMessageErrorComponent when handling other http errors', () => {
      ...
      errorHandlingService.handleError(HTTP_UNKNOWN_ERROR);
      expect(mockSnackBar.openFromComponent).toHaveBeenCalledWith(GeneralMessageErrorComponent, { data: HTTP_UNKNOWN_ERROR });
      expect(mockSnackBar.openFromComponent).toHaveBeenCalledTimes(5);
    });
